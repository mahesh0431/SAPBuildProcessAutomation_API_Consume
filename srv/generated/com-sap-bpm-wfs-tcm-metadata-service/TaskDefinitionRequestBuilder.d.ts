 ...
 */
export declare class TaskDefinitionRequestBuilder<
...
> extends RequestBuilder<TaskDefinition<T>, T> {
   ...
   */
  create(entity: TaskDefinition<T>): CreateRequestBuilder<TaskDefinition<T>, T>;
  /**
   ...
   */
  update(entity: TaskDefinition<T>): UpdateRequestBuilder<TaskDefinition<T>, T>;
  /**
...
//# sourceMappingURL=TaskDefinitionRequestBuilder.d.ts.map
