...
exports.SubstitutesRuleApi = void 0;
/*
...
const SubstitutesRuleRequestBuilder_1 = require("./SubstitutesRuleRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class SubstitutesRuleApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = SubstitutesRule_1.SubstitutesRule;
    ...
    requestBuilder() {
        return new SubstitutesRuleRequestBuilder_1.SubstitutesRuleRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(SubstitutesRule_1.SubstitutesRule, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', SubstitutesRule_1.SubstitutesRule)
            };
        }
        return this._schema;
    }
}
exports.SubstitutesRuleApi = SubstitutesRuleApi;
//# sourceMappingURL=SubstitutesRuleApi.js.map