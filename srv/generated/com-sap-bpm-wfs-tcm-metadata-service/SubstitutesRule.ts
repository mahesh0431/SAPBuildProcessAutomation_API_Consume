...
import type { SubstitutesRuleApi } from './SubstitutesRuleApi';

/**
 * This class represents the entity "SubstitutesRuleCollection" of service "com.sap.bpm.wfs.tcm.metadata".
 */
export class SubstitutesRule<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements SubstitutesRuleType<T>
{
  /**
   * Technical entity name for SubstitutesRule.
   */
  static _entityName = 'SubstitutesRuleCollection';
  /**
  ...
  constructor(readonly _entityApi: SubstitutesRuleApi<T>) {
    super(_entityApi);
  }
}

export interface SubstitutesRuleType<
